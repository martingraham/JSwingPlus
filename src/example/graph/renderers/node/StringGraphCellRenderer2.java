...
public class StringGraphCellRenderer2 extends AbstractGraphCellRenderer {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4408304228302640922L;
	...
	public StringGraphCellRenderer2 () {
	...
	public Component getGraphCellRendererComponent (final JGraph graph, final Object value,
		...
		this.setBorder (isSelected ? SELECTED_BORDER : null);
	...
	public void paintComponent (final Graphics gContext) {		
		...
		int fontSize = (int)((double)(this.getHeight() - insets.top - insets.bottom) * 0.6);
		fontSize = Math.max (0, Math.min (fontSize - fontCutoff, fonts.length - 1));
