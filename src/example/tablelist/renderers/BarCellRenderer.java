...
public class BarCellRenderer extends DefaultTableCellRenderer implements PropertyChangeListener {
	...
	Color barColour = new Color (128, 128, 224);
	...
	@Override
	 public void paintComponent (final Graphics graphics) {
		if (empty) {
			...
			final int barHeight = (int)(this.getHeight() * ratioOfMax);
			graphics.fill3DRect (0, this.getHeight() - barHeight, this.getWidth(), barHeight, true);
