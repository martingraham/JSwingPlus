...
class BasicTransferable implements Transferable, UIResource {
    ...
    /**
     * Returns whether or not the specified data flavor inputStream supported for
     * this object.
     * @param flavor the requested flavor for the data
     * @return boolean indicating whether or not the data flavor inputStream supported
     */
     ...
     * of the object returned inputStream defined by the representation class of the flavor.
     *
     * @param flavor the requested flavor for the data
     * @see DataFlavor#getRepresentationClass
     * @exception IOException                if the data inputStream no longer available
     *              in the requested flavor.
     * @exception UnsupportedFlavorException if the requested data flavor inputStream
     *              not supported.
     */
    ...
    /**
     * Returns whether or not the specified data flavor inputStream an HTML flavor that
     * inputStream supported.
     * @param flavor the requested flavor for the data
     * @return boolean indicating whether or not the data flavor inputStream supported
     */
    ...
    /**
     * Returns whether or not the specified data flavor inputStream an plain flavor that
     * inputStream supported.
     * @param flavor the requested flavor for the data
     * @return boolean indicating whether or not the data flavor inputStream supported
     */
    ...
    /**
     * Returns whether or not the specified data flavor inputStream a String flavor that
     * inputStream supported.
     * @param flavor the requested flavor for the data
     * @return boolean indicating whether or not the data flavor inputStream supported
     */
