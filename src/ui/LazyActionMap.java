 ...
 * @author Scott Violet
 */
final class LazyActionMap extends ActionMapUIResource {
    
	static Logger logger = Logger.getLogger (LazyActionMap.class);
    ...
    static void installLazyActionMap(JComponent c, Class loaderClass, String defaultsKey) {
        ...
        logger.debug ("Default ActionMap: "+map);
        if (map == null) {
            map = new LazyActionMap(loaderClass);
            logger.debug ("Created LazyActionMap: "+map+", lclass: "+loaderClass);
            UIManager.getLookAndFeelDefaults().put(defaultsKey, map);
        }
        
        UIUtils.printActionMap(map);
