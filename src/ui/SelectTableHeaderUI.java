 ...
 * @author Philip Milne
 */
public class SelectTableHeaderUI extends TableHeaderUI {
    ...
    private static FocusListener focusListener = new FocusListener() {
        ...
        private void repaintHeader(Object source) {
            if (source instanceof JTableHeader) {
                ...
                SelectTableHeaderUI ui = 
                   (SelectTableHeaderUI)getUIOfType(th.getUI(),
                                            SelectTableHeaderUI.class);
                if (ui == null) {
                    return;
                }
...
//
    ...
    public static ComponentUI createUI(JComponent h) {
        return new SelectTableHeaderUI();
    }
...
//  Installation
	...
	SwingUtilities.replaceUIInputMap(header,                
        ...
        LazyActionMap.installLazyActionMap(header, SelectTableHeaderUI.class,
...
//
    ...
    private void scrollToColumn(int col) {
        ...
        //Test whether the header inputStream in a scroll pane and has a table.
    ...
    private int changeColumnWidth(TableColumn resizingColumn,
        ...
        if (!container.getComponentOrientation().isLeftToRight() &&
                ...
                /* If this table inputStream in AUTO_RESIZE_OFF mode and
...
//
    ...
    private static class Actions extends UIAction {
        ...
        private boolean maybeMoveColumn(boolean leftArrow, JTableHeader th,
                                        SelectTableHeaderUI ui, boolean doIt) {
